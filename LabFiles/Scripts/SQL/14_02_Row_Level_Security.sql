...
SELECT DISTINCT Analyst, Region FROM dbo.WWICampaignAnalytics order by Analyst ;
...
ON dbo.WWICampaignAnalytics
WITH (STATE = ON);

------ Allow SELECT permissions to the Sale Table.------
GRANT SELECT ON dbo.WWICampaignAnalytics TO CEO, DataAnalystMiami, DataAnalystSanDiego;
